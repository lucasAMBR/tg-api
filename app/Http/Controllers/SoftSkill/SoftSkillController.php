...
class SoftSkillController extends Controller
{
    ...
    #[Endpoint(operationId: 'updateDevSoftSkills', title: 'Atualizar soft skills do desenvolvedor', description: '**operationId:** `updateDevSoftSkills` — Atualiza o nível das soft skills já registradas no perfil de desenvolvedor autenticado, respeitando o limite de pontos da senioridade e o mínimo de 10 pontos. Dispara a regeração do embedding do perfil. Em **200**, `data[]` segue o schema **Dev Soft Skill Resource** (`App\\Http\\Resources\\DevSoftSkill\\DevSoftSkillResource`).')]
